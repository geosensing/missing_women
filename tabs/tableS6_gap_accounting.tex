...
\toprule
 & \multicolumn{2}{c}{Women per 1,000 men} & & \multicolumn{3}{c}{Share of the gap} \\
...
\item Shortfall is the headline comparison of the observed pedestrian sex ratio to the age-20+ residential sex ratio. It is reported unadjusted.
\item Residential ratios are computed from the 20--24 through 80+ rows in the official Census 2011 C-14 City table; age not stated is excluded \citep{census2011c14city}.
